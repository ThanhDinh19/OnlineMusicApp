...
class ArtistDetailScreenState extends State<ArtistDetailScreen> {
  ...
  void initState() {
    ...
    checkFollowStatus(userId, widget.artistId.toString());

    artId = widget.artistId.toString();
  ...
  Future<void> checkFollowStatus(String userId, String artistId) async {
    final url = Uri.parse(
        "http://10.0.2.2:8081/music_API/online_music/artist/check_follow_status.php?user_id=$userId&artist_id=$artistId");

    final response = await http.get(url);
    if (response.statusCode == 200) {
      final data = jsonDecode(response.body);
      if(data["is_following"] == true && data["status"] == "success"){
        isFollowing = true;
      }
      else{
        isFollowing = false;
                    ...
                    children: [
                      ...
                      GestureDetector(
                        onTap: () async {
                          ...
                          final followProvider = Provider.of<FollowArtistProvider>(context, listen: false);
                          await followProvider.toggleFollowArtist(userId, artId, isFollowing);
                          print("userId : ${userId}, artistId: ${artId}");
                        },
                        child: Container(
              ...
              child: artistSongs.isEmpty
                ...
                itemBuilder: (context, index) {
                  ...
                  return ListTile(
                    ...
                    title: Row(
                      children: [
                        if (audioProvider.currentIndex == index && audioProvider.playlistId == "Artist${artId}") ...[
                                    ...
                                    children: [
                                      ...
                                      ListTile(
                                          ...
                                          onTap: () async {
                                            ...
                                            await downloadSong(songId.toString(), songTitle, audioUrl, artistName, coverUrl);
                    ...
                    onTap: () async {
                      ...
                      audioProvider.setPlaylistId("Artist${artId}");
